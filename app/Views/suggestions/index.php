...
<div class="container py-4 suggestions-page">
    <div class="hero-panel mb-4">
        <div class="p-4 p-md-5 d-flex flex-wrap justify-content-between align-items-center gap-3" style="background:transparent">
            <div>
                <span class="badge" style="background:var(--brand-1); color:#fff; border-radius:999px; padding:6px 12px;">Suggestions personnalisées</span>
                <h1 class="h2 fw-bold mb-2" style="color:var(--ink-1);">Activités et régimes adaptés à votre profil</h1>
                <p class="text-muted mb-0">Les recommandations tiennent compte de votre IMC, de vos objectifs et de votre solde.</p>
            </div>
            <?php if ($user['gold']): ?>
                <div class="badge" style="background:#fbbf24; color:#111; border-radius:999px; padding:8px 14px; font-weight:600;">Gold actif -15%</div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4">
            <div class="card rounded-4 bg-white shadow-sm h-100">
                        ...
                        <div class="card rounded-4 bg-white shadow-sm h-100">
                            <div class="card-body p-4 d-flex flex-column">
                                <div class="d-flex justify-content-between align-items-start gap-3 mb-3">
                                    ...
                                    <span class="badge" style="background:var(--accent); color:#fff; border-radius:999px; padding:6px 10px"><?= ucfirst(str_replace('_', ' ', $activite['types'])) ?></span>
                                </div>

                                <div class="p-3 rounded-3 bg-light mb-3" style="border-left:4px solid var(--brand-1)">
                ...
                <?php foreach ($suggestedRegimes as $regime): ?>
                    <div class="col-md-6 col-xl-4">
                        <div class="card rounded-4 bg-white shadow-sm h-100">
                            <div class="card-body p-4 d-flex flex-column">
                                    <div class="mb-3">
                                        <h3 class="h5 fw-bold mb-1" style="color:var(--ink-1);"><?= esc($regime['nom']) ?></h3>
                                ...
                                <?php if (!empty($regime['prix'])): ?>
                                    <div class="d-flex flex-column gap-2 mb-3">
                                        <?php foreach ($regime['prix'] as $p): ?>
                                            <div class="p-3 rounded-3 bg-light d-flex justify-content-between align-items-center" style="border-left:4px solid var(--brand-2)">
                                                <div>
                                ...
                                <a href="/suggestions/purchase/<?= $regime['id'] ?>" class="btn btn-primary mt-auto">Acheter</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
